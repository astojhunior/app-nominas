...
<head>
    <meta charset="UTF-8">
    <title>Reporte - Personal por Área</title>
...
<div class="max-w-7xl mx-auto p-8"
    ...
    <div class="bg-white border-2 border-blue-600 rounded-2xl p-8 shadow">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 mb-10">
            ...
            <div class="border border-blue-500 p-6 rounded-xl text-center card-hover">
            ...
            <div class="border border-blue-500 p-6 rounded-xl text-center card-hover">
                <p class="text-sm text-gray-600">Total de Áreas</p>
                <h3 class="text-3xl font-extrabold text-blue-700">
                    {{ $areas->count() }}
                </h3>
            </div>
            ...
            <div class="border border-blue-500 p-6 rounded-xl text-center card-hover">
                <p class="text-sm text-gray-600">Área con más personal</p>
...
<div class="overflow-x-auto mb-12">
    ...
    <!-- CONTENEDOR CON ALTURA MÁX + SCROLL -->
