...
<head>
    <meta charset="UTF-8">
    <title>Reporte - Empleados Cesados</title>
    ...
    <div class="bg-white border-2 border-blue-600 rounded-2xl p-8 shadow">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            ...
            <div class="border border-blue-500 p-6 rounded-xl text-center">
                <p class="text-sm text-gray-600">Total Cesados</p>
            ...
            <div class="border border-blue-500 p-6 rounded-xl text-center">
                <p class="text-sm text-gray-600">Áreas Afectadas</p>
                <h3 class="text-3xl font-extrabold text-blue-700">
                    {{ $areas->count() }}
                </h3>
            </div>
            ...
            <div class="border border-blue-500 p-6 rounded-xl text-center">
                <p class="text-sm text-gray-600">Cargos Afectados</p>
                <h3 class="text-3xl font-extrabold text-blue-700">
                    {{ $cargos->count() }}
                </h3>
            </div>
...
<div class="overflow-x-auto mb-16">
    ...
    <!-- CONTENEDOR CON ALTURA LIMITADA + SCROLL -->
    <div class="max-h-64 overflow-y-auto border border-blue-500 rounded-lg">
        ...
        <table class="min-w-full bg-white">
            <thead class="bg-blue-700 text-white">
                <tr>
                    ...
                    <th class="p-3 text-center">Fecha Cese</th>
                ...
                @foreach($empleados as $emp)
                    <tr class="border-b hover:bg-blue-50 transition"
                        ...
                        <td class="p-3 text-center">
                            {{ $emp->renuncia->fecha ?? $emp->fecha_cese ?? '—' }}
                        </td>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="border border-blue-500 rounded-xl p-6">
                <h2 class="text-lg font-bold text-blue-700 mb-4">Ceses por Mes</h2>
                <canvas id="graficoMeses"></canvas>
            </div>

            <div class="border border-blue-500 rounded-xl p-6">
                <h2 class="text-lg font-bold text-blue-700 mb-4">Ceses por Área</h2>
                <canvas id="graficoAreaCeses"></canvas>
            </div>
...
document.addEventListener('alpine:init', () => {
    ...
    new Chart(document.getElementById('graficoAreaCeses'), {
        type: 'bar',
        data: {
            labels: {!! json_encode($areas->pluck('nombre')) !!},
            datasets: [{
                label: 'Ceses',
                data: {!! json_encode($cesesPorArea) !!},
